  ...
  const getFilteredCache = () => {
    ...
    if (redisValues.length > 0) {
     ...
     redisKeys.forEach((el, i) => {
      ...
      <h4>The specified redis router is either inactive or not currently configured to return cache keys or values. See the <a href="https://github.com/open-source-labs/Quell" target="_blank">Quell docs</a> for configuration instructions.</h4>
    )
    return temp;
  }
